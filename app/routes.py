...
from app.forms import LoginForm,RegistrationForm, EditProfileForm, PostForm, ResetPasswordRequestFrom
...
from app.forms import EmptyForm, ResetPasswordRequestFrom, ResetPasswordForm
